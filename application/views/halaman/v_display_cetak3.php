<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <h4>CHECK IN KEHADIRAN SIDANG HARI <?php echo $tgl; ?></h4>
                ...
                <div class="table-responsive">
                    <table id="data-sidang" class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th>Ruang</th>
                            <th>Antrian</th>
                            <th style="text-align: center">Jumlah Pihak <br>Check In</th>
                            <th></th>
                        ...
                        if ($daftar_sidang->num_rows() > 0) {
                            ...
                            foreach ($daftar_sidang->result() as $row) {
                                ...
                                $hadirs=$CI->sidang->kehadiran($row->nomor_perkara,$row->tgl_sidang);
                                ...
                                if($row->no_antrian<>'') {
                                    echo "<td align='center' style='vertical-align:top'><span class='badge-pill badge-success'>$row->no_antrian_cetak</span><br><button type='button'  class='btn btn-dark btn-rounded btn-sm'  onclick=\"cetak_antrians('$noperk','$pkrid','$tglsidang','$row->ruangan_id');\"><b>Cetak</b></button></td>";
                                } else {
                                    echo "<td style='vertical-align:top'>$row->no_antrian_cetak</td>";
                                }
                                echo "<td style='vertical-align:top; text-align: center'><b>".$persen."% [".$hadirs."/".$total."]</b></td>";
                                echo "<td align='center' style='vertical-align:top'>";
                                $cetak=($jenis_antrian=='0'?'Cetak':'CheckIn');
                                if ($hadir==1) {
