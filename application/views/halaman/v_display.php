                            ...
                            <div class="card card-cascade narrower">
                                <div class="view view-cascade gradient-card-header lighten-2" style="padding: 5px 0px 0px 0px; background-color:#057050;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9" style="background-color: orange; color: black; text-align: left;">
                                ...
                                <div class="card-body card-body-cascade text-center '+i+'">
                                    ...
                                    <p class="card-text" style="font-size: 18px; font-weight: bold; color: red; margin: -13px;" id="prioritas-<?php echo $r ?>">'-'</p>
                                    <br>
